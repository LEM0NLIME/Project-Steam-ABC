										...
										<tr>
											<td>
												<div class="cart_total_box"  >
													<input type="text" readonly="readonly" class="cart_input_box" id="cartQuantity" value="0" style="border: none; background-color: transparent;">개
												</div>
											</td>
											<td>
												<div class="cart_total_box"  >
												<input type="text" readonly="readonly" class="cart_input_box"  id="cartTotal" value="0" style="border: none; background-color: transparent;"> 원
												</div>	
											</td>
										</tr>
										</tbody>
